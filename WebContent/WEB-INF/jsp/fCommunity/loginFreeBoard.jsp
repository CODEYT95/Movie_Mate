...
<% ArrayList<FboardDTO> fBoardList = (ArrayList<FboardDTO>) request.getAttribute("fBoardList");int count=1; %>
            ...
            <button class="write-btn" id="matchBoard">
      ...
      <script>
  document.getElementById("matchBoard").addEventListener("click", function() {
    window.location.href = "http://localhost:8081/MovieMate/matchCommunityController";
  });
</script>
  <script>
  ...
  function loadMoreData() {
    ...
    $.ajax({
      url: 'freeCommunityController',  // 요청할 URL
      method: 'GET',  // 요청 방식
