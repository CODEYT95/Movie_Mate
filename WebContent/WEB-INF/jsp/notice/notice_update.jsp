...
<head>
 ...
 <title>Movie Mate | 공지사항 수정</title>
 ...
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js"></script>
  ...
  $(document).ready(function () {
      ...
      $('.btn').click(function (event) {
          ...
          $.ajax({
        	    type: "POST",
        	    url: "${pageContext.request.contextPath}/UpdateNoticeController", 
        	    data: formData, 
        	    dataType: 'json',
        	    success: function (notice) {
        	    
        	        window.location.href = "${pageContext.request.contextPath}/ReadNoticeDetailController?no="+no;
        	    },
        	});
      });
  });
...
<body>
<form id="insertForm" action="${pageContext.request.contextPath}/ReadNoticeDetailController" method="post">
 	<input type="number" name="no" value="<%=request.getAttribute("noticeNo") %>" style="display:none;">
 	<input type="text" name="nick" class="user-nickname" value="<%= request.getAttribute("memberNick") %>" style="display:none;">
  <div id="root">
    <main id="contents">
      ...
      <div class="content-area">
        <div class="post-editor">
          <div class="editor-header">
            <div class="textarea1">
              <textarea name="title"id="no-line-breaks" maxlength="100" placeholder="제목을 입력해주세요." autofocus="autofocus" rows="1" style="height: 21px;"><%= request.getAttribute("noticeTitle") %></textarea>
            </div>
          </div>
          <div class="editor-main">
            <div class="main-placeholder">
              ...
              <div class="main-writer" contenteditable="true"><%= request.getAttribute("noticeContent") %></div>
          </div>
