...
<% ArrayList<MboardDTO> mBoardList = (ArrayList<MboardDTO>) request.getAttribute("mBoardList");int count=1; %>
      ...
      <header class="header">
        <nav class="navi">
          ...
          <a class="navi_a" title="search" href="http://localhost:8081/MovieMate/SearchMovie"><i class="navi-i fa-sharp fa-solid fa-magnifying-glass fa-xl"></i><br><span>발견</span></a>
