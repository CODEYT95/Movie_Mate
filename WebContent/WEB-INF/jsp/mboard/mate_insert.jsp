...
<body>
<form id="insertForm" action="/ReadMateDetailController" method="post">
  <div id="root">
    <main id="contents">
      <section class="fixed-area">
        <header class="header-wrap">
          <h1 class="header-title">매칭게시판</h1>
          <div class="left">
            <button type="button" class="back-btn" onclick="window.history.back();" style="cursor: pointer;">
      ...
      <div class="content-area">
        <div class="post-editor">
          <div class="editor-header">
            <div class="textarea1">
              <textarea name="title" maxlength="100" placeholder="제목을 입력해주세요." autofocus="autofocus" row="1" style="height: 21px;"></textarea>
            </div>
          </div>
  ...
  $(document).ready(function () {
      ...
      $('.btn').click(function (event) {
          ...
          $.ajax({
              type: "POST",
              url: "${pageContext.request.contextPath}/InsertMateController", // Correct URL based on your project
              data: formData, // Send the serialized form data
              dataType: 'json',
              success: function (result) {
                  window.location.href="${pageContext.request.contextPath}/ReadMateDetailController?no=" +result;
              },
