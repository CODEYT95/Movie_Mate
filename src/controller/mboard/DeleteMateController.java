...
@WebServlet("/DeleteMateController")
public class DeleteMateController extends HttpServlet {
    private static final long serialVersionUID = 1L;
    private MboardDAO mdao = new MboardDAO();

    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
    	RequestDispatcher rd = req.getRequestDispatcher("/WEB-INF/jsp/mboard/read_mdetail.jsp");
        rd.forward(req, res);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            int no = Integer.parseInt(req.getParameter("b_no")); // 수정할 게시글의 번호
            System.out.println(no);
            
            
            int isDeleted = mdao.deleteMboard(no);
